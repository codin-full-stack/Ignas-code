...
function login($data) {
    ...
    //pagal email patikrint ar egzistuoja failas
    //jei neegzistuoja tada echo neegzistuoja
    //jei egzistuoja tada istraukiam infromacija is json failo ir tikrinam ar json slaptazodis lygus posto slaptazodziui ir tada prisijungiam
